import { LogsModel, GraphSeriesXY, DataFrame, FieldType, TimeZone, ExploreMode } from '@grafana/data';
...
export class ResultProcessor {
  ...
  getLogsResult(): LogsModel | null {
    ...
    const maxLinesLimit = this.state?.queries?.reduce((acc, query) => acc + query.maxLines, 0) || 1000;
